...
function terbilang ($angka){
    $angka = abs($angka);
    $baca = array('', 'satu', 'dua', 'tiga', 'empat', 'lima', 'enam', 'tuju', 'delapan', 'sembilan', 'sepuluh', 'sebelas');
    $terbilang = '';
...
//tidak mengunakan bawannya karna inggris default nya
function tanggal_indonesia($tgl, $tampil_hari = true)
{
    $nama_hari  = array(
        // 'Jum\'at' karna string nay bentrok makan nay dikasih sles
